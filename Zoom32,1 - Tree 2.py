...
# HW: Delete all instances of a key.

def del_all_inst(node,key):
    if node:
...
tree5 = Node(60)
tree5.left=Node(45)
tree5.left.left=Node(30)
tree5.left.left.left=Node(30)
tree5.left.right=Node(50)
tree5.right=Node(75)
tree5.right.left=Node(70)
tree5.right.left.left=Node(70)
tree5.right.right=Node(80)

inorder(tree5)
print("")
del_all_inst(tree5,30)
del_all_inst(tree5,70)
inorder(tree5)
print("")
